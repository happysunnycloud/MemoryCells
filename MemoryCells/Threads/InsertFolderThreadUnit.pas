...
type
  TInsertFolderThread = class(TBaseThread)
  strict private
...
constructor TInsertFolderThread.Create(
  const AForm: TFormExt;
  const AParams: TParamsExt;
...
procedure TInsertFolderThread.InnerExecute;
const
  METHOD = 'TInsertFolderThread.InnerExecute';
var
  Params: TParamsExt;
begin
  try
